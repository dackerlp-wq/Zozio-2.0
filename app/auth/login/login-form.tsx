...
export function LoginForm({ next, initialSent, initialError }: LoginFormProps) {
      ...
      <div className="space-y-6">
        <div className="flex items-start gap-3 rounded-2xl bg-meadow-100 p-5 text-meadow-700 ring-1 ring-inset ring-meadow-300/40">
          ...
          <div className="space-y-1">
            <p className="font-semibold">Email odeslán</p>
            <p className="text-sm text-meadow-700/80">
              Zkontroluj svou schránku <strong>{email}</strong>. Klikni na
              odkaz a přihlásíš se.
            </p>
          </div>
        </div>
        <ZozioButton
    ...
    <div className="space-y-6">
      <form onSubmit={handleMagicLink} className="space-y-4">
        ...
        <ZozioButton
          ...
          className="w-full"
        >
          <Mail /> {isPending ? "Odesílám…" : "Pošli mi přihlašovací odkaz"}
        </ZozioButton>
      </form>
